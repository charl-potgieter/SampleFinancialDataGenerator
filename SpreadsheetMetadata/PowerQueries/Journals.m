let
    ...
    *************************************************************************************************************************/
    ...
    jnlMetadataRaw = DataAccess_JnlMetaData,
    JnlMetadataChangedType = Table.TransformColumnTypes(jnlMetadataRaw,{{"Jnl Prefix", type text}, {"Debit Account Code and Description", type text}, {"Credit Account Code and Description", type text}, {"Jnl Description", type text}, {"Base Amount Total For Month", type number}}),
    ...
    *************************************************************************************************************************/
    ...
    AddJnlMetaDataTable = Table.NestedJoin(ChangedType2, "Jnl Prefix", JnlMetadataChangedType, "Jnl Prefix", "JnlMetaDataTable", JoinKind.LeftOuter),
